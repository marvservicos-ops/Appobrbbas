...
import { Wrench, BarChart2, Users, Settings, User, Package, Menu, X, ShieldCheck, DollarSign, StickyNote, LayoutDashboard, FileText } from 'lucide-react'
...
const navItemsBase = [
  ...
  { href: '/gestao-pj', label: 'Gestão PJ', icon: FileText, adminOnly: true },
